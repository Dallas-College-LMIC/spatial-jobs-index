...
describe('AppInitializer', () => {
  ...
  describe('initialize', () => {
    ...
    it('should wait for DOM to be ready', async () => {
      ...
      const initPromise = AppInitializer.initialize('test-container', TestController, 'TestApp');
    ...
    it('should log successful initialization', async () => {
      ...
      await AppInitializer.initialize('test-container', TestController, 'TestApp');
  ...
  describe('setupGlobalErrorHandlers', () => {
    ...
    it('should handle unhandled promise rejections', () => {
      ...
      expect(ErrorHandler.logError).toHaveBeenCalledWith(error, 'Unhandled Promise Rejection');
    ...
    it('should handle global errors', () => {
      ...
      expect(ErrorHandler.logError).toHaveBeenCalledWith(error, 'Global Error', {
        filename: 'test.js',
        lineno: 42,
        colno: 13,
      });
